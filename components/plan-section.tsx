...
const PlanSection = () => {
  ...
  return (
    <div className="bg-white">
      <section className="bg-black font-bold text-white pt-16 pb-36 relative overflow-hidden [clip-path:polygon(0%_0%,100%_0%,100%_88%,0%_100%)]" id="plans">
        <Image className="absolute bottom-0 left-0 z-10" src={PlansDetails} alt="oi" />
        ...
        <div className="w-[min(77.5rem,90%)] mx-auto relative">
          ...
          <ul className="flex justify-between mt-16 *:flex *:flex-col *:items-center *:py-7 *:px-9 *:border-2 *:rounded-xl *:relative plan-ul">
